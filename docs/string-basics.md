...
<small>(Leads to: [Factor basics](factor-basics.md), [Parsing details](parse-details.md), [Regular expressions](regexps.md), [String basics - glue](string-basics-2.md))</small>
