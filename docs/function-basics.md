...
<small>(Leads to: [Anonymous functions](function-anonymous.md), [Predicate functions](function-predicate.md), [purrr basics](purrr-basics.md), [Tidy evaluation](tidy-eval.md), [Vector functions](vector-functions.md))</small>
