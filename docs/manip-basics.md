...
<small>(Leads to: [Data structure basics](data-structure-basics.md), [Exploratory data analysis (1D)](eda-1d.md), [Other single table verbs](manip-one-table.md), [Scoped verbs](manip-scoped.md), [Parsing basics](parse-basics.md), [Pipes](pipes.md), [Vector functions](vector-functions_old.md), [Vector functions](vector-functions.md), [Vector and summary functions](vector-summary-functions.md), [Window functions](window-functions.md))</small>
