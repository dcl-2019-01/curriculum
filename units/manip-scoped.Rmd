...
You have to supply a named list for this functionality to work. In this example, the names are "median" and "distinct." The scoped verb appends the name given to each function in the list to the end of each variable name. 
